...
def main():
    ...
    print("[*] Configuring 4-bit NF4 quantization settings (Strict Float16)...")
    ...
    # Force ALL floating-point parameters to float16.
    # T4 GPUs do not support bfloat16 natively, and any rogue bfloat16 tensors will crash cuBLAS.
    ...
    config_kwargs = {
        ...
        "fp16": True,   # Enabled fp16 for native T4 Tensor Core execution
